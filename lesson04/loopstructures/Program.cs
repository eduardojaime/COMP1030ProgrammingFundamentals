...
class Program
{
    static void Main(string[] args)
    {
        ...
        int counter1 = myRandom.Next(1, 11); // assigns random number from 1 to 10 (11 not included)
        int counter2 = myRandom.Next(1, 11); // assigns a different random number from 1 to 10
